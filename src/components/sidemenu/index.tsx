...
const SideMenu: React.FC = () => {
  ...
  return (
    <>
      <div  className="lg:w-[250px] border-[1px] border-[#E6EFF5] w-0 h-screen bg-white shadow-lg flex flex-col justify-start items-center transition-all duration-300 ease-in-out sm:hidden lg:flex">
